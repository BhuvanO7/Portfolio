...
let projects = [
  {
    image: 'textures/portfolio2.png',
    url: 'https://bhuvano7.github.io/index.html',
  },
  {
    image: 'textures/portfolio.png',
    url: 'https://bhuvano7.github.io/3D/',
  },

  {
    image: 'textures/calc.png',
    url: 'https://bhuvano7.github.io/calc/',
  },

  {
    image: 'textures/blog.png',
    url: ' https://bhuvano7.github.io/Blog/',
  },
  
  // {
  //   image: 'textures/ecom.png',
  //   url: 'maverick-pars.vercel.app',
  // },
];
let aboutCameraPos = {
  x: 0.12,
...
const roomLight = new THREE.PointLight(0xffffff, 1, 10);
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Maverick', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
